...
if __name__ == '__main__':
	...
	parser.add_argument('-w', '--weights',
		type=str,
		default='./yolov3-coco/tiny-yolo-obj.weights',
		help='Path to the file which contains the weights \
			 	for YOLOv3.')

	parser.add_argument('-cfg', '--config',
		type=str,
		default='./yolov3-coco/tiny-yolo-obj.cfg',
	...
	parser.add_argument('-v', '--video-path',
		type=str,
		#default='./video/car_chase_01.mp4',
	...
	parser.add_argument('-l', '--labels',
		type=str,
		default='./yolov3-coco/obj-labels',
	...
	if FLAGS.image_path:
		...
		url = "http://10.136.71.85:8080/shot.jpg"
